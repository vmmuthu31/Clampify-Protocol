 ...
 */
export const CORE_TESTNET_RPC_URL = "https://rpc.test2.btcs.network";

/**
 * Core Network Explorer URL
 */
export const CORE_TESTNET_EXPLORER_URL = "https://scan.test2.btcs.network";

/**
 * Deployed Paymaster address
 */
export const DEFAULT_PAYMASTER_ADDRESS =
  "0x9A5e0F8D2153c8391b098FfCB2404149D7e0b402";

/**
 * Deployed EntryPoint address
 */
export const DEFAULT_ENTRYPOINT_ADDRESS =
  "0x6136Bed7B15ebc86830c642500F6aeA304A6aa95";
 ...
 * User Operation ABI
 */
export const USER_OPERATION_ABI = [
